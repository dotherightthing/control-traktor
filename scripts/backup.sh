...
then
  ...
  && cp    ~/"Documents/control-traktor/live/CT6 Project/CT6.als"                                       "./src/live/CT6 Project" \
  ...
  && cp -r ~/"Documents/control-traktor/streamdeck-xl/icons/app"                                        "./src/streamdeck-xl/icons" \
  && cp -r ~/"Documents/control-traktor/streamdeck-xl/icons/button-creator"                             "./src/streamdeck-xl/icons" \
